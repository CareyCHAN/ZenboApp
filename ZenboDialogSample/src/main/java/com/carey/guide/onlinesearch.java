...
public class onlinesearch extends RobotActivity {
        ...
        mButtonGetRoomInfo.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    sFirstRoom = arrayListRooms.get(1).keyword;
...
//        if (ContextCompat.checkSelfPermission(newarrivals.this, Manifest.permission.READ_CONTACTS)
...
//        }
        ...
        robotAPI.robot.speak("請跟我說想了解的區域喔");
