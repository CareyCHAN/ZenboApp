package com.carey.robotdevsample;
...
public class RobotActivity extends com.robot.carey.robotactivity.RobotActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch(position) {
                    case 0:
                        //.speak & stopSpeak
                        subExample = new Intent(RobotActivity.this, RobotSpeak.class);
